state("NOMAD"){
    ...
    // God forgive me
    bool playButtonPointerInside: "UnityPlayer.dll", 0x1A058E0, 0x48, 0xB0, 0x10, 0x30, 0x30, 0x48, 0x28, 0x30, 0x10, 0x30, 0x8, 0x70, 0x30, 0x30, 0x30, 0x38, 0x28, 0xE0;
    bool playButtonPointerDown: "UnityPlayer.dll", 0x1A058E0, 0x48, 0xB0, 0x10, 0x30, 0x30, 0x48, 0x28, 0x30, 0x10, 0x30, 0x8, 0x70, 0x30, 0x30, 0x30, 0x38, 0x28, 0xE1;
}
...
start
{
    return current.sceneName == "MainMenuBackUp" && current.playButtonPointerInside && 
        (!current.playButtonPointerDown && old.playButtonPointerDown);
}
